...
from .configuration_megatron_gpt2 import MegatronGPT2Config
...
from .tokenization_megatron_gpt2 import MegatronGPT2Tokenizer
...
if is_torch_available():
    ...
    from .modeling_megatron_gpt2 import (
        MegatronGPT2Model,
        TheseusMegatronGPT2Model,
        TheseusMegatronGPT2ModelForGeneration,
    )
