...
BERT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    'gpt2-large-chinese': str(Path(PureWindowsPath("resources\\config\\gpt2-large-chinese.json"))),
    'gpt2-large-chinese-refine': str(Path(PureWindowsPath("resources\\config\\gpt2-large-chinese-refine.json"))),
}


class MegatronGPT2Config(PretrainedConfig):
    r"""
