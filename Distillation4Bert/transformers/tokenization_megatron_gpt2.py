...
class MegatronGPT2Tokenizer(object):
    ...
    def __init__(self, vocab_file, do_lower_case=True, max_len=None, do_basic_tokenize=True,
        ...
        if do_basic_tokenize:
            self.basic_tokenizer = MegatronGPT2BasicTokenizer(do_lower_case=do_lower_case,
                                                  never_split=never_split)
        self.wordpiece_tokenizer = MegatronGPT2WordpieceTokenizer(vocab=self.vocab)
...
class MegatronGPT2BasicTokenizer(object):
...
class MegatronGPT2WordpieceTokenizer(object):
